(function () {
  ...
  var $$core$$default = $$core$$MessageFormat; // -- MessageFormat --------------------------------------------------------
  ...
  function $$core$$MessageFormat(message, locales, formats) {
    ...
    formats = this._mergeFormats($$core$$MessageFormat.formats, formats); // Defined first because it's used to build the format pattern.
  ...
  $$es5$$defineProperty($$core$$MessageFormat, '__localeData__', {
  ...
  $$es5$$defineProperty($$core$$MessageFormat, '__parse', {
...
}).call(window); //# sourceMappingURL=intl-messageformat.js.map