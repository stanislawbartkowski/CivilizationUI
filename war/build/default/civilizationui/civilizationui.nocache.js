function civilizationui() {
  var O = 'bootstrap',
      P = 'begin',
      Q = 'gwt.codesvr.civilizationui=',
      R = 'gwt.codesvr=',
      S = 'civilizationui',
      T = 'startup',
      U = 'DUMMY',
      ...
      Zb = 'civilizationui.devmode.js',
      $b = '151BCF381D7549E4C86B43C23FF3898E',
      _b = '5A9AF367E689481BAF68AA46B6623C81',
      ac = '5FB68B6CC6291ADC77D92FD01857D46C',
      bc = '7C26928F04BB177F48B73D68E7A0A4DB',
      cc = 'F0F7FBBC78C234A66474FA82B9A1C6CC',
      dc = ':',
      ec = '.cache.js',
      fc = 'link',
      gc = 'rel',
      ...
      ic = 'href',
      jc = 'loadExternalRefs',
      kc = 'gwt/clean/clean.css',
      lc = 'end',
      mc = 'http:',
      nc = 'file:',
      oc = '_gwt_dummy_',
      pc = '__gwtDevModeHook:civilizationui',
  ...
  civilizationui.__sendStats = r;
  civilizationui.__moduleName = S;
  civilizationui.__errFn = null;
  civilizationui.__moduleBase = U;
  civilizationui.__softPermutationId = V;
  civilizationui.__computePropValue = null;
  civilizationui.__getPropMap = null;

  civilizationui.__installRunAsyncCode = function () {};

  civilizationui.__gwtStartLoadingFragment = function () {
    return null;
  };

  civilizationui.__gwt_isKnownPropertyValue = function () {
    return false;
  };

  civilizationui.__gwt_getMetaProperty = function () {
    return null;
  };
  ...
  civilizationui.__moduleStartupDone = function (e) {
    var f = t[S].bindings;

    t[S].bindings = function () {
      var a = f ? f() : {};
      var b = e[civilizationui.__softPermutationId];
  ...
  function A(k) {
    ...
    civilizationui.onScriptDownloaded = function (a) {
      l(function () {
        m(a);
      });
    };
    ...
    if (civilizationui.__errFn) {
      n.onerror = function () {
        civilizationui.__errFn(S, new Error(mb + code));
      };
    }
  ...
  civilizationui.__startLoadingFragment = function (a) {
    return D(a);
  };

  civilizationui.__installRunAsyncCode = function (a) {
    var b = v();
    var c = b.body;
  ...
  function D(a) {
    ...
    return civilizationui.__moduleBase + a;
  }
  ...
  function F() {
    ...
    civilizationui.__getPropMap = function () {
      var a = {};
    ...
    civilizationui.__computePropValue = k;
    o.__gwt_activeModules[S].bindings = civilizationui.__getPropMap;
    r(O, Yb);
    ...
    civilizationui.__softPermutationId = g;
    return D(l + ec);
  }
  ...
  function G() {
    ...
    function c(a) {
      if (!__gwt_stylesLoaded[a]) {
        ...
        p.getElementsByTagName(nb)[V].appendChild(b);
  ...
  B();
  civilizationui.__moduleBase = C();
  t[S].moduleBase = civilizationui.__moduleBase;
  var H = F();
...
civilizationui.succeeded = civilizationui();