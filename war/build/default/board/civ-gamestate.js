...
`;
  ...
  refresh(b) {
    ...
    if (C.isendofgame(b)) this.activecivname = b.board.endofgame.winner + " : " + C.localize(b.board.endofgame.wintype + "label");else this.activecivname = this.localize('nowplayinglabel', 'active', g.active);
    this.phase = g.phase;
  }
