...
C = function () {
  ...
  return {
    ...
    researchdialog(itemi, co) {
      const y = this.you();
      C.opendialogwithpar("tech-dialog", {
        "tech": y.tech,
        "toresearch": itemi
      }, null, co);
    ...
    sacrificefortech(itemi, co, fun) {
      const y = this.you();
      C.opendialogwithpar("civ-choosetechdialog", {
        "tech": y.tech,
        "toresearch": itemi,
        "nocancel": true
      }, null, co);
    ...
    **/
    journalMessage(id, params) {
      ...
      if (j == null) {
        ...
        for (var i = 0; i < params.length; i++) mess = mess + " " + params[i];
      ...
      for (var i = 0; i < params.length; i++) mess = mess.replace("%" + i + "%", params[i]);
