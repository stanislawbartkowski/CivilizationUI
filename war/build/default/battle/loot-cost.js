...
`;
  ...
  */
  ...
  _toresourcename(data) {
    if (data.name == "tech") return {
      "resource": "tech",
      "param": data.tech
    };
    if (data.name == "resource") return {
      "resource": data.resource
    };
    if (data.name == "coin" && data.coinsheet) return {
      "resource": "Coin",
      "param": C.localize("cardonsheet")
    };
    if (data.name == "hut") return {
      "resource": "Hut"
    };
    if (data.name == "village") return {
      "resource": "Village"
    };
    if (data.name == "culture") return {
      "resource": "Culture"
    };
    if (data.name == "trade") return {
      "resource": "trade"
    };
    if (data.name == "card") return {
      "resource": "card",
      "param": C.localize("cardlevel", "level", "" + data.level)
    };
    if (data.name == "coin") return {
      "resource": "Coin",
      "param": data.tech
    };
  ...
  refresh(data) {
    ...
    if (data.loot == 2) C.displayelem(this.$.level2, true, true);else C.displayelem(this.$.level1, true, true);
    const t = this.$.param;
