...
`;
  ...
  _clicked(da, id) {
    ...
    this.$.taken.addElem(da); // recalculate loot taken already

    this.$.loot.redrawnum(num + da.loot); // add to used list

    this.used.push(id); // remove text
