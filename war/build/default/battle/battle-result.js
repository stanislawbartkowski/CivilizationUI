...
`;
  ...
  _refreshclose() {
    ...
    if (res.length > 0 || !this._isloot()) this._disableclose(false);else this._disableclose(true);
  }
  ...
  refresh(data) {
    ...
    if (battle.bothsides || battle.attackerwinner && a.you || !battle.attackerwinner && d.you) this._drawloot();else this.$.battlelot.draw(null); // clear result to avoid error while running against village  
  }
