...
`;
  ...
  */
  ...
  refresh(pa) {
    // what is attacked 
    if (pa.square.numberofArmies > 0) this.object = C.localize('civarmy', 'civ', pa.square.civ);else if (pa.square.numberofScouts > 0) this.object = C.localize('civscout', 'civ', pa.square.civ);else if (pa.square.city != null) this.object = C.localize('attacknormalcity', 'civ', pa.square.civ);else this.object = C.localize('villagelabel');
